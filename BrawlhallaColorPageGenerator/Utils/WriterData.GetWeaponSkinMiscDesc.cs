...
public partial class WriterData
{
    ...
    public string GetWeaponSkinMiscDesc(WeaponSkinType weaponSkin)
    {
        ...
        return weaponSkinName switch
        {
            ...
            "Glory of the Lions" => "{{small|{{BPReward|Season Four|gold|Tier 69}}<br>{{BPReward|Season Four Classic|free|Tier 66}}}}",
            ...
            "Dwarven-Forged Greatsword" => "<span style=\"font-size:75%\">{{BPReward|Season Seven|gold|Tier 21}}<br>{{BPReward|Season Seven Classic|free|Tier 20}}</span>",
